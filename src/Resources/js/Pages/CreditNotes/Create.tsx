...
export default function Create() {
    ...
    const updateItem = (index: number, field: keyof CreditNoteItem, value: any) => {
        ...
        if (field === 'product_id') {
            ...
            if (product) {
                ...
                const lineTotal = newItems[index].quantity * product.sale_price;
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('account.credit-notes.store'));
    };
    ...
    return (
        <AuthenticatedLayout
            ...
            pageTitle={t('Create Credit Note')}
        >
            <Head title={t('Create Credit Note')} />
                    ...
                    <Card>
                        <CardContent className="space-y-4 pt-4">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    <Label htmlFor="credit_note_date">{t('Date')}</Label>
                                    <Input
                                        id="credit_note_date"
                                        type="date"
                                        value={data.credit_note_date}
                                        onChange={(e) => setData('credit_note_date', e.target.value)}
                                    />
                                    {errors.credit_note_date && <p className="text-sm text-red-600">{errors.credit_note_date}</p>}
                                </div>
                                ...
                                <div>
                                    ...
                                    <Input
                                        ...
                                        placeholder={t('Enter reason for credit note')}
                                    />
