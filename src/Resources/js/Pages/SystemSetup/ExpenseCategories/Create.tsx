...
import { CreateExpenseCategoriesProps, ExpenseCategoriesFormData } from './types';

export default function Create({ onSuccess, chartofaccounts }: CreateExpenseCategoriesProps) {
    const { t } = useTranslation();
    const { data, setData, post, processing, errors } = useForm<ExpenseCategoriesFormData>({
        category_name: '',
        category_code: '',
        gl_account_id: '',
        description: '',
    ...
    return (
        <DialogContent>
            <DialogHeader>
                <DialogTitle>{t('Create Expense Categories')}</DialogTitle>
            </DialogHeader>
